...
<body>
    ...
    <div class="col-md-4 col-lg-4 col-sm-12">
            <div class="card">
                <div class="card-header text-center"> <img  class="img-responsive" style=""  src="<?php echo asset('images/rifachon.png'); ?>" height="140px" width="150px" align="center" /></div>
                ...
                <div class="card-body">
                       ...
                       <div class="col-md-12">
                           <form method="POST" action="<?php echo route('login'); ?>" aria-label="Login">
                         <?php echo csrf_field(); ?>
...
<?php /**PATH /home/public_html/rifazzo/resources/views/auth/login.blade.php ENDPATH**/ ?>