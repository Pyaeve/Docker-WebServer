...
?>
	<main id="primary" class="site-main">
		...
		while ( have_posts() ) :
			...
			do_action( 'parablog_post_navigation' );

			if ( is_singular( 'post' ) ) {
				$related_posts_label = get_theme_mod( 'parablog_post_related_post_label', __( 'Related Posts', 'parablog' ) );
				...
				if ( $query->have_posts() ) :
					...
					<div class="related-posts">
						<?php if ( get_theme_mod( 'parablog_post_hide_related_posts', false ) === false ) : ?>
