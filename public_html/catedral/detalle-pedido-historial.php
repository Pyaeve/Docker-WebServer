<?php
    ...
    $contraentrega = Contraentrega::select($id);
    $fecha = date('d/m/Y', strtotime($contraentrega[0]['contraentrega_timestamp']));
?>
<!DOCTYPE html>
<html  >
<head>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6 mt-3">
            <a href="mis-pedidos" class="btn btnVer btn-primary" style="padding: 13px 30px; margin: 0 0 20px 0;">
