...
<!--BANNERS MAIN-->
    <section class="slider2 cid-scEavRZm1L" id="slider2-2s" style="margin-top: 3%;">
    <?php 	
    	$banners = Banners::get();
    	$cant = count($banners);
    ?>
...
<!--<section class="clients1 cid-scK991gVCa" id="clients1-4v">
        ...
        <div class="images-container container-fluid">
            ...
            <div id="store" class="marcas owl-carousel owl-theme row justify-content-center mt-4" style="z-index: 0;">
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 50");
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 45");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 40");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 35");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 30");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 25");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 24");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 23");
                    if(haveRows($productos['list'])){
                ?>
                    <div class="col-md-10"><a href="productos/descuento/23"><img src="images/23.png" alt=""></a></div>
                <?php }   ?> 

                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 22");
                    if(haveRows($productos['list'])){
                ?>
                    <div class="col-md-10"><a href="productos/descuento/22"><img src="images/22.png" alt=""></a></div>
                <?php }   ?> 

                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 21");
                    if(haveRows($productos['list'])){
                ?>
                    <div class="col-md-10"><a href="productos/descuento/21"><img src="images/21.png" alt=""></a></div>
                <?php }   ?> 
                
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 20");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 15");
                    if(haveRows($productos['list'])){
                ?>
                ...
                <?php
                    $productos = Productos::listing(9,pageNumber(),NULL,"producto_status = 1 AND producto_precio > 0 AND producto_stock > 0 AND producto_mostrar = \"S\" AND producto_descuento = 10");
                    if(haveRows($productos['list'])){
                ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img src="images/popup_index.jpeg" alt="" style="width: 100%;height: 100%;width: 90%;height: 80%;">
            </div>
        </div>
    </div>
</div>
