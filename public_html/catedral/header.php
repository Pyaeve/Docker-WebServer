...
<section class="menu menu2 cid-scF3d8JkSQ " once="menu" id="menu2-4f">
    <nav class="navbar navbar-dropdown navbar-expand-lg d-flex justify-content-md-center justify-content-lg-center justify-content-sm-right ">
        <div class="container-fluid">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="index">
                        <img src="assets/images/web-01.webp" alt="Farmacia y Perfumeria Catedral" style="height: 4.4rem;">
                    </a>
                </span>
            ...
            <div class="collapse navbar-collapse float-right" id="navbarSupportedContent">
                ...
                <div class="flexsearch d-none  d-md-block">
                ...
                <ul class="navbar-nav nav-dropdown float-right" data-app-modern-menu="true">
                    <li class="nav-item dropdown">
                        ...
                        <a class="btn btn-info-outline-success dropdown-toggle display-7" href="#" data-toggle="dropdown-submenu" aria-expanded="false">
                            ...
                            <span class="fa fa-solid fa-user"></span>&nbsp;Ingresar</a>                          
                        ...
                        <a class="btn btn-info-outline-success dropdown-toggle display-7" href="#" data-toggle="dropdown-submenu" aria-expanded="false">
                            <span class="fa fa-solid fa-user"></span>&nbsp;&nbsp; <?php $nombre_cliente = Clientes::select($cliente_id); echo "Hola ".$nombre_cliente[0]['cliente_nombre'] ?>
                        </a>
                        <div class="dropdown-menu">
                    ...
                    <li class="nav-item">
                    	<a class="btn btn-info-outline-success display-7" href="locales">
                    		...
                    		<span class="fa fa-solid fa-map-marker"></span>&nbsp;Locales</a>
                    </li>
  <li class="nav-item">

<a class="btn btn-info-outline-success display-7" href="mi-carrito">
                        <span class="fa fa-solid fa-cart-arrow-down"> <b>Mi Carrito</b>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                            ...
                            <?php 
                                ...
                                $func_google = strlen($_SESSION['cli_reg']) > 0 ? "": "onSignIn";
                            ?>
...
<br><br>
                	<a class="btn btn-info-outline-success display-7" href="mi-carrito">
                        <span class="fa fa-solid fa-cart-arrow-down">
                           Mi Carrito <span class="cant-intems ">
                                <span class="itemCartTotal"><?php echo $items_carrito; ?></span>
                            </span>
                        </span>
                        <br>
...
<br>
                	<a class="btn btn-info-outline-success display-7" href="mi-carrito">
                        <span class="fa fa-solid fa-cart-arrow-down"></span>
                        <span class="itemCartTotal" style="font-weight:bold;color:white">&nbsp;&nbsp;
                            Mi Carrito  <?php echo $items_carrito; ?>
                        </span>
                                           </a>
                </div>-->
        ...
        <!-- <div class="justify-content-center" style="background: #0f3b84;z-index:0;" > -->
            <div id="menu" class="d-none d-md-block d-lg-block">
				...
				<?php 	$categorias = Categorias::get("categoria_parent = 1 ","categoria_id ASC");
					$a = 1;
					$html="";
                    //INICIO validación de categorias 
                    foreach ($categorias as $categoria){

                        $subcat = Categorias::get("categoria_parent = ".$categoria['categoria_id']." ","categoria_nombre ASC");
                        if(haveRows($subcat)){
                            foreach ($subcat as $subv) {
                                $cates = Categorias::get("categoria_parent = ".$subv['categoria_id']." AND categoria_id IN (SELECT categoria_id FROM productos)","categoria_nombre ASC");
                                if(!$cates){
                                    $val = Categorias::get("categoria_id IN (SELECT categoria_id FROM productos p WHERE p.categoria_id = ".$subv['categoria_id'].")","categoria_nombre ASC");
                                    if(!$val){
                                        $cate .= $subv['categoria_id'].",";
                                    }
                                }
                            }   
                        }                           
                    ...
                    $not = substr($cate, 0, -1); 
                    //FIN validación de categorias 

					foreach ($categorias as $categoria):
						$html.= '<li>
								<a href="productos/'.$categoria["categoria_slugit"].'">'.$categoria["categoria_nombre"];
								$subcat = Categorias::get("categoria_parent = ".$categoria['categoria_id']." AND categoria_id NOT IN ($not)","categoria_nombre ASC");
                                //echo "<script>console.log('aa:categoria_id IN (SELECT categoria_id FROM productos) and categoria_parent = ".$categoria['categoria_id']."')</script>";
								$subclose = 0;
								if(haveRows($subcat)){
									$subclose = 1;
