...
class Mysql {
    ...
    public function Execute($sql) {
        ...
        if (!empty($sql)):
            ...
            mysqli_real_query($this->Conn, $sql) or die(mysqli_error($this->Conn));
            ...
            $res = mysqli_use_result($this->Conn);
            ...
            if (!is_bool($res)):
                ...
                while(true == mysqli_more_results($this->Conn)){
                ...
                return count($resulsets) == 1 ? $resulsets[0] : $resulsets;
