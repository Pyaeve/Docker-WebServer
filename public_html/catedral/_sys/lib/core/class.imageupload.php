	...
	*************************************/
	...
	public function Resize(){
		...
		if(!$this->_SourceFile){
			...
			$this->_Quality		= !$this->_Quality	?	90 : $this->_Quality;
	...
	public function NoResize(){
		...
		if(!$this->_SourceFile){
			...
			list($ancho, $alto) = getimagesize($this->_SourcePath . $this->_SourceFile);
			$Image = imagecreatefromjpeg($this->_SourcePath . $this->_SourceFile);
			$imagen_p = imagecreatetruecolor($ancho, $alto);
			imagecopyresampled($imagen_p, $Image, $destX, $destY, 0, 0, $ancho, $alto, $ancho, $alto);
