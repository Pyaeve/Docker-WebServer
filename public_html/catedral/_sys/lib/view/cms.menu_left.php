<ul>
	...
	<li class="hasSubmenu"> <a data-toggle="collapse" class="glyphicons cogwheels" href="#menu_config"><i></i><span>Configuraciones</span></a>
		<ul class="collapse" id="menu_config">
			...
			<li><a href="" onclick="module('parametros');return!1;"><i></i><span>Parametros</span></a></li>
		</ul>
...
<li class="glyphicons inbox"><a href="" onclick="module('demandas_insatisfechas');return!1;"><i></i><span>Demandas Insatisfechas</span></a></li>

<?php if(access('carrito')): ?>
	<li class="glyphicons remove"><a href="" onclick="module('carrito');return!1;"><i></i><span>Carritos Sin Confirmar</span></a></li>
<?php endif; ?>

<?php if(access('direcciones')): ?>
	<li class="glyphicons road"><a href="" onclick="module('direcciones');return!1;"><i></i><span>Direcciones</span></a></li>
<?php endif; ?>
