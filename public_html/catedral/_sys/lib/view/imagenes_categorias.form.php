...
$modulename.= " > ".$categoria['categoria_nombre']." > ";
$pagina = numParam('pagina');

$modulename.= $imagen_id > 0 ? "Modificar" : "Nuevo";

$data		= Imagenes_categorias::select($imagen_id);
...
if(is_array($data) && count($data) > 0 && empty($_POST)):
	...
	$fields = Imagenes_categorias::getfields();
...
<ul class="breadcrumb">
	...
	<li class="divider"></li>
	<li><a href="" onclick="module('imagenes_categorias&page=<?php echo pageNumber();?>');return!1;"><?php echo $modulename;?></a></li>
	<li class="divider"></li>
	<li><?php echo $title; ?></li>
</ul>
<div class="separator"></div>
<div class="heading-buttons">
	<h3 class="glyphicons picture" style="width:50% !important;"><i></i><a href="" onclick="module('imagenes_categorias&page=<?php echo pageNumber();?>');return!1;"><?php echo htmlspecialchars($modulename);?></a> &gt; <?php echo $title;?></h3>
	<div class="buttons pull-right">
		<a href="" class="btn btn-primary btn-icon glyphicons circle_arrow_left" onclick="module('imagenes_categorias&page=<?php echo pageNumber();?>&categoria_id=<?php echo $categoria_id; ?>&pagina=<?=$pagina?>');return!1;"><i></i>Volver</a>
	</div>
</div>
<div class="separator"></div>
<form class="form-horizontal" style="margin-bottom: 0;" id="imagenes_categorias_form" name="imagenes_categorias_form" method="post" autocomplete="off" action="js/save" target="upload_frame" enctype="multipart/form-data">
	<div class="well" style="padding-bottom: 20px; margin: 0;">
		...
		<div class="span6">
				...
				<div class="control-group<?php echo isset($error['imagen_file_name']) ? " error" : "";?>">
					...
					<div class="controls">
						...
						</div><label>(Dimensiones 415,415px)</label>
		...
		<div class="form-actions">
			...
			<input type="hidden" name="token" value="<?php echo token("Imagenes_categorias::save(".$imagen_id.")");?>" />
			<input type="hidden" name="option" value="imagenes_categorias" id="option" />
			...
			<button type="button" class="btn btn-icon btn-default glyphicons circle_remove" onclick="module('imagenes_categorias&page=<?php echo pageNumber();?>&categoria_id=<?php echo $categoria_id; ?>&pagina=<?=$pagina?>');return!1;"><i></i>Cancelar</button>
		</div>
	</div>
</form>
