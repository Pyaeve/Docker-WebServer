$(document).ready(function(){
  ...
  $(document).on("keydown", function(e) {
    if (e.which == 40) {
      ...
      var active = $('.busqueda').find(".activesearch");
      var storeTarget;
      if (active.length != 0) {
        ...
        storeTarget = $('.busqueda').first();
      }
      //Le asignamos la clase active
      storeTarget.children().toggleClass("activesearch");
      var bt = storeTarget.find("#btn_link");
      bt.focus();
      ...
      if (active.length != 0) {
        ...
        storeTarget = $('.busqueda').last();
      }
        storeTarget.children().addClass("activesearch");
        var bt = storeTarget.find("#btn_link");
        bt.focus();
