<?php
	...
	ini_set('max_execution_time', 1800000); //300 seconds = 5 minutesini_set('memory_limit', '128M');
    ...
    $cliente = $cliente[0];
    //if($cliente_id == 11066 || $cliente_id == 1702){ 
    if($cliente_id > 0){ 
        //obtener tarjetas del cliente 
        $token = md5($private_key . $cliente_id . "request_user_cards");
        $data = array(
        ...
        if($response->status == "success"){
            ...
            if($response->cards){
                ...
                $bc .= '<input class="form-check-input disabled" type="radio" name="payment" id="payment-5" value="5" disabled>
                <label for="payment-5"><span></span>Pago con tarjeta registrada</label>';
            }
    ...
    //mensaje descuento vision
    $parametro = Parametros::select(5);
    $mensaje_descuento = $parametro[0]['para_valor'];
            ...
            <div class="row">
                <div class="col-md-6 col-lg-7 mt-3">
                    ...
                    <div class="bs-example mt-3">
                        ...
                        <p class="mt-3 col-10 col-md-12 col-lg-12 col-sm-12">
                            <input class="form-check-input" type="radio" name="opcionentrega" id="delivery" value="delivery">
                            <label class="form-check-label" for="delivery"> <strong>Delivery </strong></label>
                        ...
                        <p class="mt-3 col-10 col-md-12 col-lg-12 col-sm-12">
                            ...
                            <label class="form-check-label" for="retirardesucursal"><strong>Retirar de la sucursal (Pick up)</strong></label>
                            <select name="contraentrega_local" class="form-select  mt-3" data-live-search="true" id="contraentrega_local" ">
                ...
                <div class="col-md-6 col-lg-5 mt-3">
                    ...
                    <div class="input-radio">
                        ...
                        ?>
                            ...
                            <label for="payment-2"><span></span>Pago con tarjeta de Cr&eacutedito</label>
                            ...
                            <div class="ml-3 w-100 opciones_tarj" style="display: none; font-size: 14px;" >
                                ...
                                <h7 style="color:red;display:none;font-weight: bold;" id="aviso_vision" name="aviso_vision"> <?php echo $mensaje_descuento; ?></h7><br>

                            </div><br>
                            <?php //echo $bc; ?>
                        <?php }else{ 

                                if(/*$cliente_id == 11066 || $cliente_id == 1702*/ $cliente_id > 0){ ?>
                                    <input class="form-check-input" type="radio" name="payment" id="payment-2" value="2">
                                    <label for="payment-2"><span></span>Pago en l&iacutenea con tarjeta de Cr&eacutedito</label>
                                    <br><?php echo $bc; ?>
                          <?php }else{ ?>
                                    <input class="form-check-input" type="radio" name="payment" id="payment-2" value="2">
                                    <label for="payment-2"><span></span>Pago con tarjeta de Cr&eacutedito</label>
