...
<section class="content1 cid-scEieb16NW" id="content1-2y" style="">
    <div class="row">
        ...
        <div class="" style=" width: 100%; padding: 0 60px;z-index: 0;">
            <div class="row mt-4">
                <span class="promobig <?php echo $promoClass?> "></span>
                ...
                <div class="col-md-6 col-lg-6 display-4">
                    <h4><?php echo $producto['producto_nombre']?></h4>
                    <h4><?php echo $producto['marca_nombre']?></h4>
                    
                    <p>Codigo: <?php echo $producto['producto_codigo'];
                    if($producto['producto_equivalencia']){
                    ?> 
                    <i class="fa fa-barcode fa-xl"></i> <p><?php echo " ".$producto['producto_equivalencia'];?></p>      
                    <?php } ?>
                    </p>              
                    ...
                    <!--<p>Cantidad: <?php//=$producto['producto_stock']?></p>-->
                    <div class="pl-0 pr-0 row">
                         <?php if( $producto['producto_nivel'] != "VENTA LIBRE" ){ ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <del class="prodPrecio right pt10">
                                Gs: <span style="font-size: 13px;"><?php echo $antes?></span>
                            </del>
                            <?php } ?>
                            <p class="prodPrecio left pt10">
                                Gs: <span style="font-size: 23px;"><b><?php echo $actual?></b></span>
                            </p>
                        </div>
            ...
            <?php $fichas = Productos_fichas::get("producto_id = ".$producto['producto_id']);
                if(haveRows($fichas)):  ?>
            <div class="col-md-12 col-lg-12 pt-5 display-4">
                <div class="bs-example">
                    <div class="accordion" id="accordion">
                        ...
                        ?>
                        <div class="card">
                            <div class="card-header mainficha" id="heading<?php echo $list['ficha_id']?>">
                                <h2 class="mb-0">
                                    <button type="button" class="btn btn-link ficha" data-toggle="collapse" data-target="#collapse<?php echo $list['ficha_id']?>">
                                        <?php echo strtoupper($list['ficha_nombre']);?>
                                    </button>                                  
                                </h2>
                            </div>
                            <div id="collapse<?php echo $list['ficha_id']?>" class="collapse show" aria-labelledby="heading<?php echo $list['ficha_id']?>" data-parent="#accordion">
                                <div class="card-body border-top-0">
                                    <p><?php echo utf8_encode($list["ficha_contenido"])?></p>
                                </div>
                            </div>
                        </div>
                        <?php
                ...
                <div style="padding: 10px 50px;">
                    <div class="item features-image сol-12 col-md-6 col-lg-12">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <a href="producto/<?php echo $relacion['producto_slugit']?>">
                                    <span class="icono-promo <?php echo $promoClassrel?> ico-pr"></span>
                                    <img src="<?php echo $img?>" alt="<?php echo $relacion['producto_nombre']?>" title="<?php echo $relacion['producto_nombre']?>">
                                </a>
                            </div>
                            <div class="item-content title_product" style="padding: 0 15px;">
                                 ...
                                 <p class="mbr-text text-center mb-1 mbr-fonts-style title_producto maxmin">
                                    <a href="producto/<?php echo $relacion['producto_slugit']?>" style="color: #000;">
                                        <?php echo $relacion['producto_nombre']?>  
                                    </a>
                                </p>
                                ...
                                <div class="row" style="width: 100%; margin:0; ">
                                    ...
                                    <div class="features-image сol-12 col-lg-6 p-0">
                                        ...
                                        <del class="mbr-text text-center mb-1 mbr-fonts-style title_producto" style="font-size: 12px">Gs. <?php echo $antes_r?></del>
                                    </div>
                                    <?php  }   ?>
                                    <div class="features-image сol-12 col-lg-<?php echo $col?> p-0">
                                        <!--<p class="text-center mbr-text mb-1 mbr-fonts-style title_producto"><b>Precio Ahorro</b></p>-->

                                        <p class="mbr-text text-center mb-1 mbr-fonts-style title_producto" style="font-size: 17px;"><b>Gs: <?php echo $actual_r?></b></p>
                                    </div>
                                </div>
            ...
            <li class="splide__slide">
                <div style="padding: 10px 50px;">
                    <div class="item features-image сol-12 col-md-6 col-lg-12">
                        <div class="item-wrapper">
                            <div class="item-img">
                                <a href="producto/<?php echo $relacion['producto_slugit']?>"><img src="<?php echo $img?>" alt="<?php echo $relacion['producto_nombre']?>" title="<?php echo $relacion['producto_nombre']?>"></a>
                            </div>
                            <div class="item-content title_product" style="padding: 0 15px;">
