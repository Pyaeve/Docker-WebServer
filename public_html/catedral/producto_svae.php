                        ...
                        ?>
                         <div class="product-box bg-white col-sm-6 col-md-3 col-xs-6">
                            <a href="./producto/<?php echo $relacion['producto_slugit'] ?>" title="<?php echo $relacion['producto_marca'].' '.$relacion['producto_nombre'] ?>">
                                ...
                                <div class="features-image сol-12 col-lg-6 p-0"><p class="w-100 text-left mbr-text mb-1 mbr-fonts-style title_producto">Antes</p>                                        <del class="mbr-text text-center mb-1 mbr-fonts-style title_producto" style="font-size: 12px">Gs. 65.000</del>                                    </div>                                                                        <div class="features-image сol-12 col-lg-6 p-0">                                        <p class="text-center mbr-text mb-1 mbr-fonts-style title_producto"><b>Ahora</b></p>                                        <p class="mbr-text text-center mb-1 mbr-fonts-style title_producto" style="font-size: 17px;"><b>Gs: 52.000</b></p>                                    </div>                                </div>
