                ...
                <div class="col-md-6 col-lg-5 mt-3">
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-md-6 col-lg-7 listP text-left mt-3">
                                ...
                                <div class="proalert" id="alert_stock_<?=$producto_code[0]['producto_codigo']?>"></div>
                            </div>
                        ...
                        <input type="hidden" name="productos_val" id="productos_val" value="<?=$producto_val?>">
                    ...
                    <div class="input-radio mt-2">
                        ...
                        <div class="ml-3 w-100 opciones" style="display: none; font-size: 14px;" >
                            <input type="radio" name="opcionpago" id="efectivo" value="1" checked="checked">
                            <label for="payment-2"><span></span>Efectivo</label><br>
                            <input type="radio" name="opcionpago" id="pos" value="2">
...
<script type="text/javascript">
    ...
    function verstock(){
        ...
        $.ajax({
            type: "POST",
            url: "ajax/verifica",
            data: {local:local,opcionentrega:opcionentrega,product_cant:product_cant},
            dataType: "json",
            success: function(data){
